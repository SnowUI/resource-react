...
export const Geometric05: React.FC<BackgroundProps> = ({ width = 1024, height, ...rest }) => {
  const resolvedWidth = width ?? 1024;
  // 根据 width 选择对应宽度的图片，如果没有精确匹配则使用最接近的宽度
  const closestWidth = findClosestWidth(resolvedWidth, Geometric05AvailableWidths);
  const imageSrc = Geometric05WidthMap[closestWidth as keyof typeof Geometric05WidthMap] ?? Geometric05Src;
  return (
    <img
      src={imageSrc}
      alt="Geometric05"
