...
export const Gradient01: React.FC<BackgroundProps> = ({ width = 1024, height, ...rest }) => {
  const resolvedWidth = width ?? 1024;
  // 根据 width 选择对应宽度的图片，如果没有精确匹配则使用最接近的宽度
  const closestWidth = findClosestWidth(resolvedWidth, Gradient01AvailableWidths);
  const imageSrc = Gradient01WidthMap[closestWidth as keyof typeof Gradient01WidthMap] ?? Gradient01Src;
  return (
    <img
      src={imageSrc}
      alt="Gradient01"
