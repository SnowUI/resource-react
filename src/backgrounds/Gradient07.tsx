...
const Gradient07AvailableWidths = [320, 640, 1024, 1920] as const;
...
export const Gradient07: React.FC<BackgroundProps> = ({ width = 1024, height, ...rest }) => {
  const resolvedWidth = width ?? 1024;
  // 根据 width 选择对应宽度的图片，如果没有精确匹配则使用最接近的宽度
  const closestWidth = findClosestWidth(resolvedWidth, Gradient07AvailableWidths);
  const imageSrc = Gradient07WidthMap[closestWidth as keyof typeof Gradient07WidthMap] ?? Gradient07Src;
  return (
    <img
      src={imageSrc}
      alt="Gradient07"
