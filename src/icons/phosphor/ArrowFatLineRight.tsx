...
const meta = { collection: 'phosphor', usageName: 'arrow-fat-line-right', componentName: 'ArrowFatLineRight' } as const;
const defaultViewBox = "0 0 32 32";

export const ArrowFatLineRight: React.FC<IconProps> = React.forwardRef<SVGSVGElement, IconProps>((props, ref) => {
