...
const meta = { collection: 'phosphor', usageName: 'arrow-u-down-left', componentName: 'ArrowUDownLeft' } as const;
const defaultViewBox = "0 0 32 32";

export const ArrowUDownLeft: React.FC<IconProps> = React.forwardRef<SVGSVGElement, IconProps>((props, ref) => {
