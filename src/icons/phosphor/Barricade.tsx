...
const meta = { collection: 'phosphor', usageName: 'barricade', componentName: 'Barricade' } as const;
const defaultViewBox = "0 0 32 32";

export const Barricade: React.FC<IconProps> = React.forwardRef<SVGSVGElement, IconProps>((props, ref) => {
