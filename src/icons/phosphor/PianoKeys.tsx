...
const meta = { collection: 'phosphor', usageName: 'piano-keys', componentName: 'PianoKeys' } as const;
const defaultViewBox = "0 0 32 32";

export const PianoKeys: React.FC<IconProps> = React.forwardRef<SVGSVGElement, IconProps>((props, ref) => {
