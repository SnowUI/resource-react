...
const meta = { collection: 'phosphor', usageName: 'television-simple', componentName: 'TelevisionSimple' } as const;
const defaultViewBox = "0 0 32 32";

export const TelevisionSimple: React.FC<IconProps> = React.forwardRef<SVGSVGElement, IconProps>((props, ref) => {
