...
const meta = { collection: 'snowui', usageName: 'icon-size-28', componentName: 'IconSize28' } as const;
const defaultViewBox = "0 0 32 32";

export const IconSize28: React.FC<IconProps> = React.forwardRef<SVGSVGElement, IconProps>((props, ref) => {
  return <IconBase ref={ref} {...props} meta={meta} viewBox={defaultViewBox} weights={weights as any} />;
});

IconSize28.displayName = 'IconSize28';

export default IconSize28;
