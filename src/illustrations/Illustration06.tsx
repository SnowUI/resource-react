...
export const Illustration06: React.FC<BackgroundProps> = ({ width = 320, height, ...rest }) => {
  const resolvedWidth = width ?? 320;
  // 根据 width 选择对应宽度的图片，如果没有精确匹配则使用最接近的宽度
  const closestWidth = findClosestWidth(resolvedWidth, Illustration06AvailableWidths);
  const imageSrc = Illustration06WidthMap[closestWidth as keyof typeof Illustration06WidthMap] ?? Illustration06Src;
  return (
    <img
      src={imageSrc}
      alt="Illustration06"
