...
const Illustration14AvailableWidths = [160, 320, 640, 1024] as const;
...
export const Illustration14: React.FC<BackgroundProps> = ({ width = 320, height, ...rest }) => {
  const resolvedWidth = width ?? 320;
  // 根据 width 选择对应宽度的图片，如果没有精确匹配则使用最接近的宽度
  const closestWidth = findClosestWidth(resolvedWidth, Illustration14AvailableWidths);
  const imageSrc = Illustration14WidthMap[closestWidth as keyof typeof Illustration14WidthMap] ?? Illustration14Src;
  return (
    <img
      src={imageSrc}
      alt="Illustration14"
