...
export const Illustration18: React.FC<BackgroundProps> = ({ width = 320, height, ...rest }) => {
  const resolvedWidth = width ?? 320;
  // 根据 width 选择对应宽度的图片，如果没有精确匹配则使用最接近的宽度
  const closestWidth = findClosestWidth(resolvedWidth, Illustration18AvailableWidths);
  const imageSrc = Illustration18WidthMap[closestWidth as keyof typeof Illustration18WidthMap] ?? Illustration18Src;
  return (
    <img
      src={imageSrc}
      alt="Illustration18"
