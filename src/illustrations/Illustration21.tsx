...
const Illustration21AvailableWidths = [160, 320, 640, 1024] as const;
...
export const Illustration21: React.FC<BackgroundProps> = ({ width = 320, height, ...rest }) => {
  const resolvedWidth = width ?? 320;
  // 根据 width 选择对应宽度的图片，如果没有精确匹配则使用最接近的宽度
  const closestWidth = findClosestWidth(resolvedWidth, Illustration21AvailableWidths);
  const imageSrc = Illustration21WidthMap[closestWidth as keyof typeof Illustration21WidthMap] ?? Illustration21Src;
  return (
    <img
      src={imageSrc}
      alt="Illustration21"
