...
export const Illustration27: React.FC<BackgroundProps> = ({ width = 320, height, ...rest }) => {
  const resolvedWidth = width ?? 320;
  // 根据 width 选择对应宽度的图片，如果没有精确匹配则使用最接近的宽度
  const closestWidth = findClosestWidth(resolvedWidth, Illustration27AvailableWidths);
  const imageSrc = Illustration27WidthMap[closestWidth as keyof typeof Illustration27WidthMap] ?? Illustration27Src;
  return (
    <img
      src={imageSrc}
      alt="Illustration27"
