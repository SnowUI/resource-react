...
export const Image01: React.FC<BackgroundProps> = ({ width = 320, height, ...rest }) => {
  const resolvedWidth = width ?? 320;
  // 根据 width 选择对应宽度的图片，如果没有精确匹配则使用最接近的宽度
  const closestWidth = findClosestWidth(resolvedWidth, Image01AvailableWidths);
  const imageSrc = Image01WidthMap[closestWidth as keyof typeof Image01WidthMap] ?? Image01Src;
  return (
    <img
      src={imageSrc}
      alt="Image01"
